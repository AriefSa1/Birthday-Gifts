...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body className="h-full w-full flex flex-col bg-[#0b060a] text-pink-50 relative overflow-x-hidden overflow-y-auto overscroll-x-none select-none">
        
        {/* FITUR ESTETIK 1: Efek Kerlipan Bintang Animatif */}
        <StarBackground />

        {/* FITUR ESTETIK 2: Ambient Glowing Aura Overlay */}
        <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-pink-900/10 blur-[120px] pointer-events-none -z-20 animate-pulse" style={{ animationDuration: '8s' }} />
        <div className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-purple-950/15 blur-[150px] pointer-events-none -z-20 animate-pulse" style={{ animationDuration: '12s' }} />
        ...
        <main className="flex-grow z-10 relative h-full w-full">
          {children}
        </main>
